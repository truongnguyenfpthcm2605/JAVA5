		...
		<form action="/mail/send" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">To *</label> <input type="text"
					name="to" class="form-control" required="required" />

			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">CC </label> <input type="text"
					name="cc" class="form-control" />

			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">BCC </label> <input type="text"
					name="bcc" class="form-control" />
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Files </label> <input type="file"
					name="files" class="form-control" multiple />

			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">Content *</label>
				<textarea id="" cols="30" rows="5" class="form-control" name="body" required="required"></textarea>
